...
source_env="source \"\$HOME/goplus/env/env.bash\" #!! InGop env profile !!"
...
ingop_env_profile="$HOME"/goplus/env/env.bash
...
shell_content="export GOROOT=$HOME/goplus/env/go
export GOPATH=$HOME/goplus/env/go/workspace
export GOBIN=$HOME/goplus/env/go/bin
